---
title: "Caching"
description: "The in-process memoization model used by Bonyan-API."
---

Bonyan-API uses a small in-process cache in `utils/cache.ts`. It is a `Map`
...
If three clients trigger the same cold key at the same time, Bonyan-API runs
