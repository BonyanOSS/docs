...
<CardGroup cols={2}>
  ...
  <Card title="Make your first API request" icon="rocket" href="/quickstart">
    Call Etha3a in under a minute using cURL, JavaScript, Python, PHP,
    or Go.
  </Card>
...
flowchart LR
    ...
    Docs --> Etha3aDocs["docs.bonyanoss.org/etha3a<br/>Etha3a API docs"]
    Home --> Projects["Project apps<br/>Current and future public products"]
    Api["api.bonyanoss.org<br/>Unified API gateway"] --> Etha3aApi["/etha3a/v1<br/>Etha3a API"]
...
| [Etha3a API](/etha3a) | The first major API surface: Quran, tafsir, reciters, azkar, hadith, prayer, Hijri, and Qibla. |
| [Guides](/guides/design-principles) | Standards for building, documenting, operating, and graduating projects. |
| [Reference](/reference) | Endpoint-level details for the Etha3a API modules. |
